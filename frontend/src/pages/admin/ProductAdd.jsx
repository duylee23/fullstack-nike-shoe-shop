  ...
  return (
      <div className='w-full'>
          <div className='w-full flex items-center justify-between'>
            ...
            {/* form start */}
            <h2 className='text-center mt-4 font-bold text-textOrange'>ADD NEW PRODUCT</h2>

          <form class="w-[70%] mx-auto">
              <div class="relative z-0 w-full mb-5 group">
                  <input type="text" name="floating_email" id="floating_email" class="block py-2.5 px-0 w-[50%] text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-borderOrange peer" placeholder=" " required />
