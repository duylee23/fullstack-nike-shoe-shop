          ...
          <form className="w-[70%] mx-auto" onSubmit={handleSubmitEdit}>
              <div className=' flex justify-around gap-4'>
                  ...
                  <div className='flex-1'>
                      ...
                      <input type="text"   name='price' id="small-input" onChange={(event) => handleInput(event) } value={product.price} className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 " />
                  </div>
              </div>
              <div className='flex justify-around gap-4'>
                {/* <div className='flex-1'>
                  ...
                  <div className="mb-5">
                      <label htmlFor="large-input" className="block mb-2 text-sm font-medium text-gray-900 ">Product category</label>
                      <input type="text"  name='category' id="large-input" onChange={(event) => handleInput(event)} value={product.category} className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 " />
                  </div>
